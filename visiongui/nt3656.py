...
class Nt3656(object):
    ...
    writeDefault=False
    hsv_h_lo = ntproperty( '/Preferences/hsv_h_lo', 53.0, writeDefault=writeDefault )
    hsv_h_hi = ntproperty( '/Preferences/hsv_h_hi', 103.0 , writeDefault=writeDefault )
    ...
    vis_cam_brightness = ntproperty( '/Preferences/vis_cam_brightness', 30, writeDefault = True )

...
class dreadbotVisionCalibrateUI(App):
    ...
    def setHsvValues(self):
        ...
        nt3656.hsv_h_lo = float(  self.hueLowText.get_text() )
        nt3656.hsv_h_hi = float(  self.hueHighText.get_text() )
        nt3656.hsv_h_lo = float(  self.satLowText.get_text() )
        nt3656.hsv_h_lo = float(  self.satLowText.get_text() )
        nt3656.hsv_h_lo = float(  self.valLowText.get_text() )
        nt3656.hsv_h_lo = float(  self.valLowText.get_text() )
        nt3656.vis_cam_brightness = int(  self.brightText.get_text() )

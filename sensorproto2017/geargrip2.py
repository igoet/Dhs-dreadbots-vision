...
class GripPipeline:
    ...
    def __init__(self):
        ...
        self.__hsv_threshold_hue = [50, 90] #[50.0, 90.0]
        self.__hsv_threshold_saturation = [0.0, 255.0]
        self.__hsv_threshold_value = [ 20, 255.0]

#changed by Stephen to above values
#        self.__hsv_threshold_hue = [60.0, 86.0]
#        self.__hsv_threshold_saturation = [0.0, 255.0]
#        self.__hsv_threshold_value = [ -0.1, 255.0]
...
#        self.__hsv_threshold_value = [100.0, 255.0]
        ...
        self.__filter_contours_min_area = 900 #1000.0
    ...
    def process(self, source0):
        ...
        print("pipeline.hsv_threshold_hue=%s" % self.__hsv_threshold_hue)
        print("pipeline.hsv_threshold_saturation=%s" % self.__hsv_threshold_saturation)
        print("pipeline.hsv_threshold_value=%s" % self.__hsv_threshold_value)        
